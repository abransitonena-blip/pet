...
import { Check, Clipboard, Download, FileCode2, FileText, RotateCcw } from 'lucide-react'
...
export default function AdminTicketDetail({ ticketId }: { ticketId: string }) {
  ...
  if (!ticket) return <EmptyState icon={<FileText size={24} />} title="Ticket inexistente" description="La sesión todavía no tiene un recibo interno persistente." />
