...
export default function StepWalker({
  ...
  return (
    <div>
      ...
      <p className="text-xs mb-4 px-3 py-2 rounded-lg" style={{ background: 'var(--glass-bg)', color: 'var(--text-muted)', border: '1px solid var(--border)' }}>
        Esta es una preferencia, no una confirmación. El paseador asignado final puede variar según disponibilidad.
      </p>
